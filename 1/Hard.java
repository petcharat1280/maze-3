...
public class Hard extends World
{
    ...
    {    
        ...
        addObject(new monster(), 19, 3);
        addObject(new monster(), 23, 21);
        addObject(new monster(), 35, 29);
        addObject(new monster(), 13, 31);
        addObject(new food(), 13, 1);addObject(new food(), 11, 3);addObject(new food(), 25, 3);addObject(new food(), 33, 3);
        addObject(new food(), 5, 7);addObject(new food(), 1, 9);addObject(new food(), 17, 9);addObject(new food(), 35, 11);
        addObject(new food(), 29, 11);addObject(new food(), 39, 15);addObject(new food(), 3, 17);addObject(new food(), 25, 19);
        addObject(new food(), 13, 21);addObject(new food(), 23, 23);addObject(new food(), 9, 25);addObject(new food(), 37, 23);
        addObject(new food(), 15, 27);addObject(new food(), 31, 27);addObject(new food(), 39, 29);addObject(new food(), 19, 33);
        addObject(new food(), 1, 35);addObject(new food(), 15, 35);addObject(new food(), 29, 37);addObject(new food(), 39, 39);
    }
