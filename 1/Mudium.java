...
public class Mudium extends World
{
    ...
    {    
        ...
        addObject(new monster(), 21, 11);
        addObject(new monster(), 33, 29);
        addObject(new monster(), 17, 39);
        addObject(new monster(), 11, 37);
        addObject(new food(), 9, 1);addObject(new food(), 37, 1);addObject(new food(), 13, 3);addObject(new food(), 3, 5);
        addObject(new food(), 5, 11);addObject(new food(), 25, 5);addObject(new food(), 13, 7);addObject(new food(), 35, 5);
        addObject(new food(), 27, 11);addObject(new food(), 37, 13);addObject(new food(), 25, 13);addObject(new food(), 5, 15);
        addObject(new food(), 21, 19);addObject(new food(), 11, 25);addObject(new food(), 19, 29);addObject(new food(), 35, 25);
        addObject(new food(), 31, 29);addObject(new food(), 25, 33);addObject(new food(), 35, 39);addObject(new food(), 17, 35);
        addObject(new food(), 11, 11);addObject(new food(), 27, 3);addObject(new food(), 7, 21);addObject(new food(), 31, 19);
    }
